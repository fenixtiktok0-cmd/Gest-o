...
const MUSICA_API_BASE = 'https://api.xtream-music.com';

async function consultarContaMusica(usuario, senha) {
  if (!usuario || !senha) {
    return { erro: 'Usuário e senha são obrigatórios.' };
  }
  return consultarPlayerApi(MUSICA_API_BASE, usuario, senha);
}
